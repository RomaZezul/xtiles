  ...
  >
    ...
    >
      <div class="toolmenu_modal_ws-container">
        <div class="buttons_tool_menu-ws" @click="deleteWs">
          <svg
            width="16"
            height="16"
            viewBox="0 0 16 16"
        ...
        <div class="buttons_tool_menu-ws" @click="rename">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
            width="16"
...
export default {
  ...
  computed: {
    GETshowModal() {
      return this.$store.state.workspace.toolmenu.showModal;
    },
    coords() {
      return this.$store.state.workspace.toolmenu.coords;
    },
  },
};
</script>
